        ...
        <div className="max-w-[1180px] mx-auto px-5 sm:px-8">
          ...
          <header className="max-w-3xl mb-10">
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-bold text-[#12151B] tracking-tight">
              Technical Architecture & AI Case Studies
            </h1>
            <p className="font-body text-base text-[#585D67] mt-4 leading-relaxed">
              In-depth engineering analyses on custom SaaS development,
              autonomous AI voice agents, and cloud enterprise modernization —
              written for founders, CTOs, and tech leaders.
            </p>
          </header>
            ...
            <Card3D intensity={5} className="mb-10">
              <Link href={`/blog/${featuredPost.slug}`} className="block">
                <motion.div
                  ...
                  className="xmark bg-white border border-[#C7C9C0] p-8 rounded-xs shadow-3d hover:border-[#1F3D8C] transition-all group"
                >
            ...
            {(activeCategory === "All" && !searchQuery.trim()
              ...
              <Card3D key={post.slug} intensity={8} className="h-full">
                <motion.div
                  ...
                  className="h-full"
                >
                  <article className="xmark bg-white border border-[#C7C9C0] p-6 rounded-xs shadow-3d hover:border-[#1F3D8C] transition-all flex flex-col justify-between h-full group">
                    <div>
            ...
            <div className="bg-[#12151B] text-white p-8 rounded-xs shadow-2xl border border-[#12151B] flex flex-col sm:flex-row items-center justify-between gap-6 xmark">
              <div className="space-y-2 text-center sm:text-left">
                <div className="font-mono text-xs font-bold text-[#FF4B23] uppercase tracking-wider">
                  BESPOKE ENGINEERING BLUEPRINT
                </div>
                <h3 className="font-display text-2xl sm:text-3xl font-bold text-white tracking-tight">
                  Need a custom software architecture roadmap?
                </h3>
                <p className="font-body text-sm text-[#8A8E96] max-w-xl">
                  Talk directly with our lead engineering team. We will analyze
                  your operational specs and deliver a complete feasibility
                  study.
                </p>
              </div>
